...
5. Set up your Github repo to deploy your rendered presentation as a website. You can do this as follows:
  ...
  2. Click "Pages" in the left side-menu.
  3. Click on The dropdown menu that says "none" and select "main".
  4. A new dropdown will appear to the right of the one from the above step. Use it to select "docs".
  5. Your presentation is ready to deploy! :sparkles:
